...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/264169ee0fcf77ee27001900c0d1035e.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/8da3d6e1b7a2f9448c08ded2739271c6.data',
                        frameworkUrl: 'Build/fb1a9fe0e8e7bed1c866125bb8110124.framework.js',
                        codeUrl: 'Build/b06071930d58a0fd1e36f2bf51eb4b9f.wasm',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'Pipoza',
                        productName: 'Arcade Highway Racing',
                        productVersion: '1.0',
